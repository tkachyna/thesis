...
"""
    ...
    date: 8/5/2023
    brief: This file contains functions that output statistical values about a given run.
"""

import numpy as np
from gif import create_gif
from trails_plots import print_result_trail
...
def print_best_of_run(best_of_run):
    ...
    print_result_trail(best_of_run['path'])
...
def print_final_results(fitnesses, best_of_run):
    ...
    print_result_trail(result_trail)
    print("\n" + "**  Solution Representation:" + "\n")
    best_of_run['individual'].print_tree()
    print("\n" + "** Solution Info: " + "\n")
